...
## 마지막 업데이트
2026-05-27T10:51:34+0900 — Step 4/11 완료
...
## 다음 할 일
- Step 4: query-hooks-and-store
  - `src/hooks/useItems.ts` — TanStack Query 훅 (useItems, useItem, useCreateItem, usePatchItem, useDeleteItem)
  - `src/stores/filterStore.ts` — Zustand 필터 스토어 (type, status 필터 상태 + setType/setStatus/reset)
  - 낙관적 업데이트(usePatchItem, useDeleteItem)와 query invalidation 처리
