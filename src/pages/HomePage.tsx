      ...
      <header className="sticky top-0 z-10 bg-[var(--color-bg)] border-b border-[var(--color-border)] flex items-center justify-between px-4 h-14">
        ...
        <div className="flex items-center gap-1">
          ...
          <Link
            to="/settings"
            aria-label="설정"
            className="flex h-11 w-11 items-center justify-center rounded-[8px] text-[var(--color-text-sub)] hover:bg-[var(--color-surface)] hover:text-[var(--color-text-primary)] transition-colors"
          >
